...
class Constants(object):
    ...
    settings_text = {
        "registration": {"ru": "регистрация", "en": None},
        "please_select_utc": {"ru": "Пожалуйста выберите свой часовой пояс, сделать это можно под сообщением о "
                                    "регистрации или в настройках (/settings)!", "en": None},
        "selecting_utc": {"ru": "установка uts", "en": None},
        "utc_set": {"ru": "Часовой пояс успешно установлен на UTC {time_zone}", "en": None},
    }
