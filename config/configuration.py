class Settings:
    ...
    max_reports_per_day = 10  # наибольшее разрешённое число жалоб от одного пользователя в день
    ...
    user_commands = {
        ...
        "help": {
            ...
            "text": {"ru": "<b>{bot_name}</b> - это бот позволяющий создавать напоминания без строгого формата.\n\n"
                           ...
                           "❗ Чтобы лучше понять, какие ещё варианты бот может обработать, пожалуйста, <b><u>ознакомьтесь с примерами</u></b>!\n\n"
                           ...
                           "- через 10 мин проверить духовку\n"
                           "- через 2 часа 10 минут сделать зарядку\n"
                           "- 10:15 пора выходить на встречу\n"
                           "- послезавтра в 14 не забыть пообедать перед выходом\n"
                           "- 17 апреля в 2.45 билеты на самолет\n"
                           "- завтра в 15 часов 35 минут зайти на онлайн конференцию\n"
                           "- 25.05 в 13.30у меня через час собеседование\n\n"
        ...
        "my_reports": {
            "description": "выводит последние репорты",
            "no_reports": {"ru": "⚡️ У вас нет репортов или администратор уже рассмотрел их и заархивировал!", "en": None},
            "list_title": {"ru": "<b><u>Вот ваши репорты:</u></b>\n\n", "en": None},
        },
    }
